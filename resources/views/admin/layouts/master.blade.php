                            ...
                            <ul class="nav nav-main">
                                ...
                                <li class="nav-parent">
                                    ...
                                    <ul class="nav nav-children">
                                        ...
                                        <li class="nav-parent">
                                            <a href="#">
                                                Icons <span class="mega-sub-nav-toggle toggled pull-right"
                                        ...
                                        <li class="nav-parent">
                                            <a href="#">
                                                Animations <span class="mega-sub-nav-toggle pull-right"
                                                    data-toggle="collapse"
                                        ...
                                        <li class="nav-parent">
                                            <a href="#">
                                                Loading <span class="mega-sub-nav-toggle pull-right"
                                                    data-toggle="collapse"
                        ...
                        <section class="panel">
                            <header class="panel-heading">
                                <div class="panel-actions">
                                    ...
                                    <a href="#" class="panel-action panel-action-dismiss"
                    ...
                    <div class="col-md-6">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <p class="panel-subtitle">It's easy to create custom graphs on Porto Admin Template,
                                                        ...
                                                        <li>
                                                            <div class="checkbox-custom checkbox-default">
                                                                ...
                                                                <label class="todo-label"
                                                                    for="todoListItem1"><span>Lorem ipsum dolor sit
                                                                        amet</span></label>
                                                            </div>
                                                        ...
                                                        <li>
                                                            <div class="checkbox-custom checkbox-default">
                                                                <input type="checkbox" id="todoListItem3"
                                                                    class="todo-check">
                                                                <label class="todo-label"
                                                                    for="todoListItem3"><span>Lorem ipsum dolor sit
                                                                        amet</span></label>
                                                            </div>
                                                            <div class="todo-actions">
                                                                <a class="todo-remove" href="#">
                                                        ...
                                                        <li>
                                                            <div class="checkbox-custom checkbox-default">
                                                                <input type="checkbox" id="todoListItem5"
                                                                    class="todo-check">
                                                                <label class="todo-label"
                                                                    for="todoListItem5"><span>Lorem ipsum dolor sit
                                                                        amet</span></label>
                                                            </div>
                                                            <div class="todo-actions">
                                                                <a class="todo-remove" href="#">
                        ...
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">
                                    <span
                                        class="label label-primary label-sm text-weight-normal va-middle mr-sm">198</span>
                                            ...
                                            <li>
                                                <div class="tm-box">
                                                    ...
                                                    <p>
                                                        ...
                                                        Porto Admin is <span class="text-primary">#awesome</span>
                                                    </p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="tm-box">
                                                    ...
                                                    <div class="thumbnail-gallery">
                                                        <a class="img-thumbnail lightbox"
                                                            href="{{ asset('assets/images/projects/project-4.jpg') }}"
                                                            data-plugin-options='{ "type":"image" }'>
                                                            <img class="img-responsive" width="215"
                                                                src="{{ asset('assets/images/projects/project-4.jpg') }}">
                                                            <span class="zoom">
                                    ...
                                    <table class="table table-striped mb-none">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div
                                                        class="progress progress-sm progress-half-rounded mt-xs light">
                                                        <div class="progress-bar progress-bar-primary"
                                                            role="progressbar" aria-valuenow="60" aria-valuemin="0"
