            ...
            <div class="heading d-flex gap-10 justify-content-center">
              ...
              >
                ...
                <!-- <form class="col-lg-5 d-flex justify-content-center flex-column gap-20">
                  ...
                  <div class="mb-3">
                    <textarea class="form-control" id="text-no-field" rows="3"
                ...
                <div class="elfsight-app-ac002fc6-841f-40ac-a83f-2dd27a1c1f68 col-xl-6 col-lg-6 col-md-10 col-sm-12 col-12" data-elfsight-app-lazy>
                </div>
